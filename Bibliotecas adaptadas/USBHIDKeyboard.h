...
// Motivo: Envia caracteres no formato ABNT ao invés de US-ASCII
...
// Detalhes: Deve substituir o arquivo original USBHIDKeyboard.ccp, provavelmente em .../ArduinoData/packages/esp32/hardware/esp32/2.0.14/libraries/USB/src
// =======================================================================
#pragma once
#include "Print.h"
#include "USBHID.h"
