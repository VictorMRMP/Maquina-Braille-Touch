...
const UnicodeLookup kbdbr_1[] PROGMEM = 
{
  ...
  {0x00ba, 0x32 | MOD_ALTGR},	// Masculine Ordinal Indicator <-- CORRIGIDO (era 0x28)
  ...
  {0x0055, 0x18 | MOD_SHIFT},	// Latin Capital Letter U  <-- CORRIGIDO  {0x0049, 0x0c | MOD_SHIFT},	// Latin Capital Letter I
  ...
  {0x007d, 0x32 | MOD_SHIFT},	// Right Curly Bracket <-- CORRIGIDO (era 0x28)
  ...
  {0x0075, 0x18},	// Latin Small Letter U  <-- CORRIGIDO  {0x0069, 0x0c},	// Latin Small Letter I
  ...
  {0x005d, 0x32},	// Right Square Bracket <-- CORRIGIDO (era 0x28)
...
{
  // ... (tabela de deadkeys completa, sem mudanças) ...
...
// MUDANÇA: A linha abaixo foi removida. O objeto será criado no seu .ino
